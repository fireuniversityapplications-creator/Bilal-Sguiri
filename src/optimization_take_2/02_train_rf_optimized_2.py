...
RF_CONFIG = {
    'n_estimators': 300,       # Number of trees (Higher = Better but slower)
    'max_depth': 25,           # How deep each tree can grow (Higher = More complex patterns)
    'min_samples_split':5,    # Minimum samples required to split a node (Prevents overfitting)
    'max_features': 'log2',
